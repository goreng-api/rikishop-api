...
// --- Class Util (Logika Enkripsi dari Skrip Anda) ---
class Util {
...
/**
 * Fungsi Logika Utama (dari skrip Anda)
 */
...
module.exports = function(app) {
    ...
    // Saya letakkan di /download/twitter-dl
    app.get('/download/twitter-dl', async (req, res) => {
        ...
        // 2. Cek Parameter URL
        if (!url) {
            return res.status(400).json({ status: false, error: 'Parameter url (link post) diperlukan' });
        }
